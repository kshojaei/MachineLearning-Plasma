...
plt.title("Bayesian Model: MC Dropout", fontsize=16, fontweight=16)
...
#plt.plot(E, (unif_t(E)), 'g', linewidth=2)
...
#bayes_mc = r2_score((unif_t(E)), (unif_mean(E)))
#print('r2 score', bayes_mc)



'''
np.savetxt('Total_LM_scatter_bayesMC_500.csv',  
