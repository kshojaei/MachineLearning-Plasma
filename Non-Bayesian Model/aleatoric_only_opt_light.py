...
#model.save("aleatoric_model_one.h5")
#model.save_weights('aleatoric_one.h5')
# load model


'''
model.load_weights('aleatoric_one_opt_one.h5')
#model.summary()
# summarize model
#model.summary()
# evaluate the model
...
preds = model_sd_mean.predict(x_pred)[0]*100
stand = model_sd_sd.predict(x_pred)[0]*100
preds_up = preds + 2*stand
preds_low = preds -2*stand
true = ((y_test[u,:]))*100
